...
ut2il.py <-  util (the name derivation) [makes it easier to tab to]
...
from uTorrent.UTorrent import *
from uTorrent.constants import *
...
if options.is_start_all is True:
    start_torrents()

if options.is_list_files is True:
    list_files()

if options.is_quick_stats is True:
    quick_stats()

if options.is_list_settings is True:
    list_settings()
